...
namespace CinemaBooking.Areas.Admin.Controllers
{
    ...
    public class AdminCombosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TenCombo,MoTa,Gia,HinhAnh,ImageFile,Loai")] Combo combo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaCombo,TenCombo,MoTa,Gia,HinhAnh,ImageFile,Loai")] Combo combo)
        {
